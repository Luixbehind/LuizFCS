...
void moveTempMesa()
{
    ...
    if(temp[op1]==NULL)
    {
        printf("Temporário vazio nesta posição, não é possível realizar a operação.\n");
    }
    else
    {
...
int main()
{
    ...
    while(op!=8)
    {
        ...
        if(temp[l]==NULL&&temp[l+1]==NULL&&temp[l+2]==NULL&&temp[l+3]==NULL&& primMesa[l]==NULL && primMesa[l+1]==NULL && primMesa[l+2]==NULL && primMesa[l+3]==NULL && primMesa[l+4]==NULL && primMesa[l+5]==NULL &&primMesa[l+6]==NULL && primMesa[l+7]==NULL)
        {
            system("cls");
            ...
            printf("                                        .!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!:.\n");
            getchar();
            printf("OBRIGADO POR JOGAR, ATÉ OUTRA HORA, BYEBYE!!");
            break;
        }
    }
    return 0;
